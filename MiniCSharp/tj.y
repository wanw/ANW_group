...
function:		  accessmodif type IDENT '('
					 ...
					 args_e ')' '{' statements '}'
					{
						...
						symtab->OutScope();
						symtab->AddSym($3, 2, $2->type, $6, $2->type, $$);
					}
				...
				| type variables ';'
					{
						...
						for(int i = 0; i < $2->variables->size(); i++)
							symtab->AddSym($2->variables->at(i)->name, 4, $1->type);
					}
				| ';'
					{
					}
